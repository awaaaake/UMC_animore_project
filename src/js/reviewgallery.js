...
const ReviewGallery = () => {
  ...
  const handleDivClick = (index) => {
    switch (index) {
      case 0:
        window.location.href = '/reservelist'; // 첫 번째 div를 클릭했을 때 이동할 사이트 주소
        break;
      case 1:
        window.location.href = '/reservelist'; // 두 번째 div를 클릭했을 때 이동할 사이트 주소
        break;
      case 2:
        window.location.href = '/reservelist'; // 세 번째 div를 클릭했을 때 이동할 사이트 주소
        break;
      case 3:
        window.location.href = '/reservelist'; // 세 번째 div를 클릭했을 때 이동할 사이트 주소
        break;
